...
// /*amount of rotation (in radians) per key click*/
// #define ANGLE_RADIANS ANGLE * PI / 180.0

// cosine of angle 
// #define COS_ANGLE_RADIANS cos(ANGLE_RADIANS)

// /*sine of angle */
// #define SIN_ANGLE_RADIANS sin(ANGLE_RADIANS)
