...
// extern double gravityY;
extern double thrust;
// extern double thrustY;
...
void updateParameters() {
    ...
    lander.bottomLeftY = newY(lander.bottomLeftY, vY);
    lander.topLeftY = newY(lander.topLeftY, vY);
    lander.topRightY = newY(lander.topRightY, vY);
    lander.bottomRightY = newY(lander.bottomRightY, vY);
    lander.thrusterY = newY(lander.thrusterY, vY);

    //update the net x- and y-accelerations
    aX = (thrusterOn * thrust) * cos(attitude_radians);
    aY = gravity + (thrusterOn * thrust) * sin(attitude_radians);
